...
//  private ToggleButton torchButton;
  ...
  void onShutterButtonPressContinuous() {
    ...
    if (lastResult != null) {
      ...
      Toast toast = Toast.makeText(this, PersianReshape.reshape("دوباره تلاش کنید ..."), Toast.LENGTH_SHORT);
  ...
  private boolean setTargetLanguage(String languageCode) {
    ...
    targetLanguageReadable = "Persian";/*LanguageCodeHelper.getTranslationLanguageName(this, languageCode);*/
    return true;
  }
  ...
  private void initOcrEngine(File storageRoot, String languageCode, String languageName) {    
    ...
    indeterminateDialog.setTitle(PersianReshape.reshape("لطفا شکیبا باشید ..."));
    String ocrEngineModeName = getOcrEngineModeName();
   /* if (ocrEngineModeName.equals("Both")) {
      indeterminateDialog.setMessage("Initializing Cube and Tesseract OCR engines for " + languageName + "...");
    } else {*/
      indeterminateDialog.setMessage(PersianReshape.reshape("در حال آماده سازی ..."));
//    }
  ...
  boolean handleOcrDecode(OcrResult ocrResult) {
    ...
    sourceLanguageTextView.setVisibility(View.INVISIBLE);
    ...
    if (isTranslationActive) {
      ...
      translationLanguageLabelTextView.setVisibility(View.INVISIBLE);
      ...
      translationLanguageTextView.setVisibility(View.INVISIBLE);
  ...
  void showLanguageName() {   
    Toast toast = Toast.makeText(this, PersianReshape.reshape("خوش آمدید"), Toast.LENGTH_LONG);
    toast.setGravity(Gravity.TOP, 0, 0);
    toast.show();
  }
  ...
  void displayProgressDialog() {
    ...
    //} else {
      indeterminateDialog.setMessage(PersianReshape.reshape("در حال انجام عملیات ..."));
    //}
    indeterminateDialog.setCancelable(false);
    indeterminateDialog.show();
  }
